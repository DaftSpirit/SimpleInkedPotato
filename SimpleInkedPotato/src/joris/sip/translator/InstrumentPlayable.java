...
public class InstrumentPlayable {
	...
	public InstrumentPlayable(String name, ArrayList<Integer> notes,
			ArrayList<Integer> durations, int rep) {
		this.name = name;
		this.notes = new ArrayList<Integer>(notes);
		this.durations = new ArrayList<Integer>(durations);
		this.repetition = rep;
	}
